...
%  Load base datasets into struct S (no Gmin/GΔ).
%
...
addParameter(p,'outdir','datasets',@(s)ischar(s)||isstring(s));
...
t1=load('datasets/GHF_Hazzard_interp.mat','GHF_Hazzard_interp');   Hazz    = t1.GHF_Hazzard_interp;    clear t1
t1=load('datasets/GHF_Martos_interp.mat','GHF_Martos_interp');     Mart    = t1.GHF_Martos_interp;     clear t1
t1=load('datasets/GHF_Shen_interp.mat','GHF_Shen_interp');         Shen    = t1.GHF_Shen_interp;       clear t1
t1=load('datasets/GHF_Stal_interp.mat','GHF_Stal_interp');         Stal    = t1.GHF_Stal_interp;       clear t1
t1=load('datasets/GHF_Losing_interp.mat','GHF_Losing_interp');     Los     = t1.GHF_Losing_interp;     clear t1
t1=load('datasets/GHF_An_interp.mat','GHF_An_interp');             An      = t1.GHF_An_interp;         clear t1
t1=load('datasets/GHF_FoxMaule_interp.mat','GHF_FoxMaule_interp'); Fox     = t1.GHF_FoxMaule_interp;   clear t1
t1=load('datasets/GHF_Haeger_interp.mat','GHF_Haeger_interp');     Haeger  = t1.GHF_Haeger_interp;     clear t1
t1=load('datasets/GHF_Lucazeau_interp.mat','GHF_Lucazeau_interp'); Lucazeau = t1.GHF_Lucazeau_interp;  clear t1 
...
S.titles = {'Fox Maule','Hazzard','Martos','Shen','Stål','An','Lösing','Haeger','Lucazeau'};
...
q = load('datasets/specularity.mat','Q'); 
S.Q = q.Q; clear q
...
tmp=load('datasets/Ts_interp.mat','Ts_interp'); S.Ts = tmp.Ts_interp; clear tmp
tmp=load('datasets/Mb_interp.mat','Mb_interp'); S.Mb = tmp.Mb_interp; clear tmp
tmp=load('datasets/mouginot_icevel.mat','speed'); S.icevel = tmp.speed; clear tmp
...
if isfile('datasets/UNC_Hazzard_interp.mat')
    u = load('datasets/UNC_Hazzard_interp.mat','UNC_Hazzard_interp');
    S.unc.Hazzard = u.UNC_Hazzard_interp; clear u;
end
if isfile('datasets/UNC_Martos_interp.mat')
    u = load('datasets/UNC_Martos_interp.mat','UNC_Martos_interp');
    S.unc.Martos = u.UNC_Martos_interp; clear u;
end
if isfile('datasets/UNC_Shen_interp.mat')
    u = load('datasets/UNC_Shen_interp.mat','UNC_Shen_interp');
    S.unc.Shen = u.UNC_Shen_interp; clear u;
end
if isfile('datasets/UNC_Stal_interp.mat')
    u = load('datasets/UNC_Stal_interp.mat','UNC_Stal_interp');
    S.unc.Stal = u.UNC_Stal_interp; clear u;
end
if isfile('datasets/UNC_Haeger_interp.mat')
    u = load('datasets/UNC_Haeger_interp.mat','UNC_Haeger_interp');
    S.unc.Haeger = u.UNC_Haeger_interp; clear u;
end
if isfile('datasets/BMIN_Losing_interp.mat')
    b = load('datasets/BMIN_Losing_interp.mat','BMIN_Losing_interp');
    S.bounds.Losing_min = b.BMIN_Losing_interp; clear b;
end
if isfile('datasets/BMAX_Losing_interp.mat')
    b = load('datasets/BMAX_Losing_interp.mat','BMAX_Losing_interp');
    S.bounds.Losing_max = b.BMAX_Losing_interp; clear b;
end
if isfile('datasets/UNC_Lucazeau_interp.mat')
    u = load('datasets/UNC_Lucazeau_interp.mat','UNC_Lucazeau_interp');
